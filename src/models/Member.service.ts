...
class MemberService {
	private readonly memberModel; // member schema model class
	constructor() {
	...
	public async addUserPoint(member: Member, point: number): Promise<Member> {
		...
		const result = await this.memberModel
			.findOneAndUpdate(
				{ _id: memberId, memberStatus: MemberStatus.ACTIVE, memberType: MemberType.USER },
	...
	public async getRestaurant(): Promise<Member> {
		const result = this.memberModel.findOne({ memberType: MemberType.RESTAURANT }).exec();
